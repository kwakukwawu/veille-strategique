...
class FAOScraper(BaseScraper):
    def __init__(self):
        ...
        self.index_paths = ['/','/procurement','/opportunities']
    ...
    def scrape(self, mots_cles=None):
        logger.info(f"[{self.source_nom}] Démarrage scraping FAO")
        ...
        for path in self.index_paths:
            ...
            for a in candidats:
                ...
                common_keywords = ['procurement', 'tender', 'opportunity', 'call', 'contract', 'bid', 'appel', 'offre']
                ...
                try:
                    ...
                    logger.exception(f"Erreur parsing FAO page {full_url}: {e}")
